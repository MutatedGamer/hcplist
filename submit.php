<?php
	...
	if($_POST['health_anal_org_3']!=""){$health_anal_org_1=$_POST['health_anal_org_3'];} else {$health_anal_org_3='Not applicable';}
	if($_POST['health_anal_role_3']!=""){$health_anal_role_1=$_POST['health_anal_role_3'];} else {$health_anal_role_3='Not applicable';}
